var CACHE_NAME='mein-geldplan-v0.99.37';
var APP_SHELL=[
  './','./index.html','./design-refresh.css?v=7','./app.js?v=0.99.37','./manifest.webmanifest','./icon.svg','./apple-touch-icon.png',
  ...
  './lib/maintenance-ui.js','./lib/recovery-store.js','./lib/preferences-ui.js','./lib/pending-salary.js','./lib/payroll-control.js','./lib/payroll-control-ui.js','./lib/payroll-control-ui-v2.js','./lib/payroll-net-breakdown.js','./lib/payroll-net-ui.js','./lib/payroll-learning.js','./lib/salary.js','./lib/salary-net-effects.js','./lib/salary-ui.js','./lib/pdf.js','./lib/payslip.js'
];
