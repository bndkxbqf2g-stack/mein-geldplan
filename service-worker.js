var CACHE_NAME='mein-geldplan-v0.99.3';
var APP_SHELL=[
  './','./index.html','./design-refresh.css?v=3','./app.js?v=0.99.3','./manifest.webmanifest','./icon.svg',
  ...
  './lib/maintenance-ui.js','./lib/pending-salary.js','./lib/salary.js','./lib/salary-ui.js','./lib/pdf.js','./lib/payslip.js'
];
