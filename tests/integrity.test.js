...
test('sichtbare Aktionsbuttons sind im JavaScript verdrahtet',()=>{
  ['incomeBtn','expenseBtn','correctionBtn','withdrawBtn','savingRateBtn','pendingSalaryBtn','pendingSalaryDeleteBtn','addFixBtn','timeReportBtn','exportBtn','importBtn','updateBtn','resetBtn'].forEach(id=>assert.match(allJs,new RegExp(id),id));
});
...
test('Gehaltsprognose bleibt auf Zeitnachweis und sicheren Speicher fokussiert',()=>{
