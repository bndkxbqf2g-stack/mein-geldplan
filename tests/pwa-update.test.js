...
test('Service Worker hält alle lokalen Kernmodule offline vor',()=>{const sw=fs.readFileSync(path.join(root,'service-worker.js'),'utf8');for(const f of ['lib/budget-ui.js','lib/savings-ui.js','lib/fixed-costs-ui.js','lib/history-ui.js','lib/maintenance-ui.js','lib/preferences-ui.js','lib/pending-salary.js','lib/salary-ui.js','lib/storage.js','config/salary-2026.js'])assert.match(sw,new RegExp(f.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')));});
