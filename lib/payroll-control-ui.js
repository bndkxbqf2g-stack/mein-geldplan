...
export function renderPayrollControl(){
  ...
  for(const item of controls){
    ...
    if(!item.hasDetailedForecast&&netBreakdown.source!=='legacy-summary-split')card.appendChild(note('Für die komponentengenaue Kontrolle diesen Zeitnachweis einmal neu einlesen. Ältere gespeicherte Prognosen enthalten noch keine Einzelbestandteile.','note payroll-alert'));
