...
import {buildPayrollControlHistory,buildPayrollCarryovers,payrollControlStatusLabel} from './payroll-control.js';
  ...
  for(const item of controls){
    ...
    if(incoming.length){
      ...
      if(item.actualPayout==null&&item.expectedPayout!=null&&carryTotal>0.005){
        ...
        const small=document.createElement('small');small.textContent='Reguläres Oktober-Soll bleibt unverändert';l.appendChild(small);
