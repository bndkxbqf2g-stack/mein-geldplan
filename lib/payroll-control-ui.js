...
import {buildPayrollControlHistory,buildPayrollCarryovers,payrollCarryoverRegularSollLabel,payrollCardDisplay,payrollProjectedPayout,payrollControlStatusLabel,visiblePayrollControls} from './payroll-control.js';
...
export function renderPayrollControl(){
  ...
  for(const item of controls){
    ...
    const summaryEntries=display.waiting
      ?[['Soll-Brutto',item.expectedGross],['Prognose Auszahlung',item.expectedPayout]]
      :[['Prognose Auszahlung',item.expectedPayout],['Tatsächlich ausgezahlt',item.actualPayout],['Netto-Differenz',item.payoutDifference]];
