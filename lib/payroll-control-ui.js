...
export function renderPayrollControl(){
  ...
  for(const item of controls){
    ...
    const netBreakdown=buildPayrollNetBreakdown({forecast,actual,variableRows:item.variableRows,retro:item.retro,estimatedNetImpact:item.estimatedNetImpact});
